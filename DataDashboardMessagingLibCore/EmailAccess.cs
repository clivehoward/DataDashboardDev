using DataDashboardMessagingLibCore.Interfaces;
...
Because WindowsAzure.Storage when referenced in a library targeting .NET Framework creates
a conflict in a .NET Core project using that library, we've had to create a version of this library
that targets .NET Core instead of .NET Framework. Hence, this library is identical to DataDashboardMessagingLib

*/

namespace DataDashboardMessagingLibCore
{
